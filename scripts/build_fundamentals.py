...
FOCUS: dict[str, dict[str, Any]] = {
    "CU": {"route": "cu", "contradiction": "矿紧无解(TC低位,铜矿资本开支不足)支撑中长期偏多;但短期宏观定价(美元/中国信用/COMEX-LME价差)——铜博士。需求电网/AI电力是中期增量,地产后周期是拖累。", "marginal_focus": "COMEX-LME价差|美元/中国社融PMI|TC低位|LME铜库存|电网招标", "metrics": [
        ("a10134435", "LME 铜库存", "吨", "SMM", "海外去库是否延续"),
        ("s20015675", "洋山铜溢价", "美元/吨", "SMM", "中国进口买盘是否回归"),
        ("ID00188319", "上海电解铜库存", "万吨", "Mysteel", "国内是否真正补库")]},
    "AL": {"route": "al", "contradiction": "短期地缘溢价退潮(霍尔木兹停火,伦铝3250-3300命门);中长期海外复产+投产(EGA 2027Q1/巴林/高盛供给+62万吨,缺口72→10万吨)+国内铝棒累库(需求见顶),供给宽松化方向明确,铝锭去库(产能红线)是唯一支撑。", "marginal_focus": "伦铝3250-3300|EGA/巴林复产|铝棒库存连3周斜率|铝锭是否转累|现货升贴水", "metrics": [
    ...
    "AU": {"route": "au", "contradiction": "实际利率压制vs央行购金托底(~1000吨/年)+避险,金脱离商品周期独立走强——纯宏观。", "marginal_focus": "10Y/实际利率|美元DXY|黄金ETF持仓(SPDR,新闻盯)|金银比|央行购金量|8月CPI/9月FOMC", "metrics": [
        ("GM0000032808", "美国10年国债收益率", "%", "Mysteel", "利率锚(压制金价)"),
        ("g02801716", "美元指数", "点", "SMM", "美元锚"),
        ("ID01589555", "伦敦金CFD", "美元/盎司", "Mysteel", "外盘锚(国际金价)")]},
    "AG": {"route": "ag", "contradiction": "实际利率压制+无央行购金缓冲(贵金属弱腿),金银比68-70高位——纯宏观,看美债/美元/美国数据。", "marginal_focus": "金银比|实际利率|美元|白银ETF持仓(iShares,新闻盯)|8月CPI/9月FOMC", "metrics": [
        ("GM0000032808", "美国10年国债收益率", "%", "Mysteel", "利率锚(压制银的弱腿)"),
        ("g02801716", "美元指数", "点", "SMM", "美元锚"),
        ("ID00265536", "伦敦银定盘价", "美元/盎司", "Mysteel", "外盘锚(国际银价)")]},
    "SN": {"route": "sn", "contradiction": "矿端偏紧——银漫停产(复产无期)+佤邦复产上限50%推迟2027+刚果金扰动,叠加再生锡收紧,供给收缩;但现货贴水(基差-650)显示高价压制下游焊料需求,盘面强现货弱。锡已金融化(对SPX相关0.4),短期跟宏观/半导体,中长期靠矿紧+AI焊料需求。", "marginal_focus": "LME锡0-3升贴水|上期所仓单5,128吨(-71)转累|现货基差-650收敛|印尼对华进口回升|银漫复产|江西再生锡厂检修|SOX与锡价背离", "metrics": [
